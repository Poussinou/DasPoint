...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegisterButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent registerIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://point.im/register"));
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String userLogin, String password) {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                if (!response.isSuccessful()) throw new IOException("Unexpected code " + response);
                    ...
                    tokens = response.body().string();

                    Log.d("DP", "Response: " + tokens);
                    return true;
                }
            ...
            if (success) {
                if (tokens.contains("token")) {
                    try {
                        ...
                        String csrf_token = jsonObject.getString("csrf_token");
                        SharedPreferences.Editor editor = prefs.edit();
                        editor = prefs.edit();
                        editor.putString("username", mUserLogin);
