...
public class Subscriber {
    ...
    public Subscriber(String userName, CommonRequestCallback commonRequestCallback, boolean subscribe) {
        mUserName = userName;
            ...
            public void run() {
                ...
                try {
                    ...
                    request = new Request.Builder()
                            .url(Constants.USER_SUBSCRIBE + mUserName)
                    ...
                    if (responseString.equals("true")) {
                        Message msg = networkBackgroundRequestHandler.obtainMessage(MSG_SUBSCRIBED, 0, 0, "You have subscribed to " + mUserName);
                        // отправляем
                        ...
                        try {
                            ...
                            if (subscribeJsonResult.has("error")) {
                                ...
                                Message msg = networkBackgroundRequestHandler.obtainMessage(MSG_SUBSCRIBED, 0, 0, "You have unsubscribed from " + mUserName);
                                // отправляем
                                networkBackgroundRequestHandler.sendMessage(msg);
                            }
            ...
            public void run() {
                ...
                try {
                    ...
                    if (responseString.equals("true")) {
                        ...
                        Message msg = networkBackgroundRequestHandler.obtainMessage(MSG_ERROR, "Ошибка: подписаться нельзя");
                        networkBackgroundRequestHandler.sendMessage(msg);
//                          UNCOMMENT THIS WHEN @arts FIXES API RESPONSE
//                        try {
//                            JSONObject subscribeJsonResult = new JSONObject(responseString);
//
//                            if (subscribeJsonResult.has("error")) {
